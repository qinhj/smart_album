...
def tiorb_face_cluster(image_dir, *args, **kwargs):
    result_file = os.path.normpath(os.path.join(kwargs["workspace"], "output.json"))
    args = ["/usr/bin/tiorb", "face", image_dir, result_file]
    try:
...
if __name__ == "__main__":
    tiorb_face_cluster(os.path.realpath("data/images"), workspace="/tmp")
