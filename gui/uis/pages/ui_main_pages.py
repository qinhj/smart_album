...
"}")
        ...
        self.page_3_widget = QWidget(self.page_3)
        self.page_3_widget.setObjectName(u"page_3_widget")

        self.page_3_layout.addWidget(self.page_3_widget)

        self.page_3_scrollArea = QScrollArea(self.page_3)
        self.page_3_scrollArea.setObjectName(u"page_3_scrollArea")
        self.page_3_scrollArea.setStyleSheet(u"background: transparent;")
        self.page_3_scrollArea.setFrameShape(QFrame.NoFrame)
        self.page_3_scrollArea.setVerticalScrollBarPolicy(Qt.ScrollBarAsNeeded)
        self.page_3_scrollArea.setWidgetResizable(True)
        self.page_3_scrollAreaWidgetContents = QWidget()
        self.page_3_scrollAreaWidgetContents.setObjectName(u"page_3_scrollAreaWidgetContents")
        self.page_3_scrollAreaWidgetContents.setGeometry(QRect(0, 0, 832, 548))
        self.page_3_scrollAreaWidgetContents.setStyleSheet(u"background: transparent;")
        self.page_3_scrollArea.setWidget(self.page_3_scrollAreaWidgetContents)

        self.page_3_layout.addWidget(self.page_3_scrollArea)
